(function (factory) {
    ...
    Elevation.addInitHook(function () {
      ...
      this.on("elepoint_added", function (e) {
        ...
        var speed = 0;
        if (e.point.meta && e.point.meta.speed) speed = e.point.meta.speed;else if (deltaT > 0) {
          var delta = (data[i].dist - data[i > 0 ? i - 1 : i].dist) * 1000;
          speed = Math.abs(delta / deltaT * this._timeFactor) * this._speedFactor; // Try to smooth "crazy" speed values.
